...
\parencite{anon1956lu},
\parencite{marx1867ccp},
\parencite{clarkeNDeci}.
\end{egcite}

Pages are set off with a colon, and multiple works are separated with a semicolon.
...
\begin{bibexbox}
{kuehner.blass1890ef}
Kühner, R., rev. Blass, F. (1890–2), \emph{Ausführliche grammatik der griechischen sprache}, i: \emph{Elementar- und Formenlehre} (Hannover: Hahnsche Buchhandlung).
\toggletrue{blx@bibliography}
\tcblower
\begin{Verbatim}
