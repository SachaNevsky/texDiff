...
devraient fonctionner sur les systèmes 64~bits.
...
\end{alltt}
      Les éléments mis à jour sont la plupart du temps des packages et classes,
      mais il arrive qu'un nouvel exécutable soit ajouté. Pour qu'un tel binaire
      soit accessible au système, il est nécessaire de mettre à jour les liens
      symboliques, ce qui peut être fait en lançant :
\begin{alltt}
> tlmgr path add
\end{alltt}
    \item[Installations multiples :] supposons par exemple que vous conserviez
      ...
      de la 2020 à 2019, il sera suffisant de lancer\footnote{En supposant que
        ces \TL{} ont été installées dans le dossier
        \dirname{/usr/local/texlive/}, sous-dossiers \dirname{2019} et
        \dirname{2020}.} :
\begin{alltt}
